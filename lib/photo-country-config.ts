...
export const COUNTRY_PROFILES: Record<CountryCode, CountryProfile> = {
  US: { code: "US", flag: "🇺🇸", country: "United States", heading: "Embassy-ready U.S. visa and passport photos.", description: "Upload once. We check face, expression, eyewear, composition, and the final 600 × 600 output before you pay.", sizeLabel: "2 × 2 inch", shortSize: "US 2 × 2", widthMm: 50.8, heightMm: 50.8, pixelWidth: 600, pixelHeight: 600, headHeightMm: 28, topMarginMm: 5.5, background: "linear-gradient(135deg,#071a4a 0%,#173c91 52%,#07152f 100%)", accent: "#67e8f9", accentSoft: "#cffafe", ink: "#082f49" },
  KR: { code: "KR", flag: "🇰🇷", country: "Korea", heading: "대한민국 여권사진을 정확한 규격으로 준비하세요.", description: "대한민국 여권용 3.5 × 4.5 cm 구도와 흰색 배경, 얼굴 위치를 결제 전에 확인합니다.", sizeLabel: "35 × 45 mm", shortSize: "KR 3.5 × 4.5", widthMm: 35, heightMm: 45, pixelWidth: 413, pixelHeight: 531, headHeightMm: 28, topMarginMm: 4, background: "linear-gradient(135deg,#071c4b 0%,#22569d 48%,#9f1239 115%)", accent: "#f43f5e", accentSoft: "#ffe4e6", ink: "#4c0519" },
