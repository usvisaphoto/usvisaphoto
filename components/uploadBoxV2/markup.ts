...
<main class="wrap">
  ...
  <section id="resultPanel" class="result-panel" style="display:none;">
    ...
    <div class="basic-preview-status">
  <div class="basic-preview-x">×</div>
  <div class="basic-preview-message">
    <strong>BACKGROUND REMOVAL ONLY</strong>
    <span>This is not your final photo.</span>
  </div>
</div>
...
<div class="eru-long-arrow" aria-hidden="true"></div>
<div id="eru-included-note" class="eru-included-note">

  <strong>YOUR PHOTO ISN'T FINISHED YET</strong>

  <span>
    This preview shows the validated crop and background removal only.
    Your final photo can be further refined with Embassy-Ready Upgrade.
  </span>

  <button
    id="eru-scroll-btn"
    type="button"
    class="eru-scroll-btn"
  >
    VIEW EMBASSY-READY UPGRADE
  </button>

  <div class="eru-preview-time">
    <span class="eru-clock">◷</span>
    <span>
      Preview your upgraded photo in <strong>about 1 minute.</strong>
    </span>
  </div>
   ...
   <button id="download-btn" type="button" style="display:none;" aria-hidden="true">Internal Preview</button>
    ...
    <section id="professional-retouch-card" class="professional-retouch-card">
      ...
      <div style="display:flex;align-items:baseline;gap:8px;margin:8px 0 10px;"><span style="text-decoration:line-through;opacity:.5;font-weight:800;">$14.99</span><strong id="eru-main-price" style="font-size:26px;color:#0f766e;">$9.99</strong><span style="font-size:11px;font-weight:900;color:#92400e;background:#fef3c7;border-radius:999px;padding:4px 8px;">GRAND OPENING · 33% OFF</span></div>
